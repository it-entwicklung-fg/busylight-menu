...
option1.triggered.connect(lambda: Color(0, 255, 0, tray, iconGreen))
option2.triggered.connect(lambda: Color(255, 0, 0, tray, iconRed))
option3.triggered.connect(lambda: Color(0, 0, 255, tray, iconBlue))
option4.triggered.connect(lambda: Color(255, 255, 0, tray, iconYellow))
...
suboption1.triggered.connect(lambda: Color(0, 255, 0, tray, iconGreen))
suboption2.triggered.connect(lambda: Color(255, 0, 0, tray, iconRed))
suboption3.triggered.connect(lambda: Color(0, 0, 255, tray, iconBlue))
suboption4.triggered.connect(lambda: Color(255, 255, 0, tray, iconYellow))
suboption5.triggered.connect(lambda: Color(255, 255, 255, tray, iconWhite))
